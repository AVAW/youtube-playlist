...
/**
 * @ORM\Entity(repositoryClass=SlackUserPresenceRepository::class)
 */
class SlackUserPresence implements \Stringable, TimestampableInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=SlackUser::class, mappedBy="presence", cascade={"persist", "remove"})
     */
