...
/**
 * @ORM\Entity(repositoryClass=SlackConversationRepository::class)
 * @ORM\Table(indexes={@ORM\Index(name="idx_identifier", columns={"identifier"})})
 */
class SlackConversation implements \Stringable, TimestampableInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=SlackUser::class, mappedBy="conversations")
     */
    private Collection $users;

    /**
     * @ORM\ManyToMany(targetEntity=SlackTeam::class, inversedBy="conversations")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=SlackConversationPlaylist::class, mappedBy="conversation", orphanRemoval=true)
     * @Groups({"playlist"})
     */
    ...
    public function addUser(SlackUser $user): self
    {
    ...
    public function removeUser(SlackUser $user): self
    {
    ...
    public function addTeam(SlackTeam $team): self
    {
    ...
    public function removeTeam(SlackTeam $team): self
    {
    ...
    /**
     * @return Collection|SlackConversationPlaylist[]
     */
    ...
    public function addConversationPlaylist(SlackConversationPlaylist $conversationPlaylist): self
    {
    ...
    public function removeConversationPlaylist(SlackConversationPlaylist $conversationPlaylist): self
    {
