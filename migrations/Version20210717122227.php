 ...
 */
final class Version20210717122227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE google_user (id INT AUTO_INCREMENT NOT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', profile_id VARCHAR(255) NOT NULL, displayed_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, surname VARCHAR(255) DEFAULT NULL, picture VARCHAR(1024) DEFAULT NULL, email_verified TINYINT(1) DEFAULT NULL, locale VARCHAR(10) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX idx_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, play_id INT DEFAULT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', url VARCHAR(1024) NOT NULL, youtube_id VARCHAR(64) NOT NULL, published_at DATETIME DEFAULT NULL, title VARCHAR(1024) DEFAULT NULL, description VARCHAR(2048) DEFAULT NULL, channel_title VARCHAR(255) DEFAULT NULL, videos_amount INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D782112D25576DBD (play_id), INDEX idx_identifier (identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist_play (id INT AUTO_INCREMENT NOT NULL, playlist_id INT DEFAULT NULL, video_id INT NOT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', started_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_FE90E9D86BBD148 (playlist_id), INDEX IDX_FE90E9D829C1004E (video_id), INDEX idx_identifier (identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist_video (id INT AUTO_INCREMENT NOT NULL, playlist_id INT NOT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', video_id VARCHAR(255) NOT NULL, title VARCHAR(512) NOT NULL, published_at DATETIME NOT NULL, video_owner_channel_id VARCHAR(255) DEFAULT NULL, video_owner_channel_title VARCHAR(255) DEFAULT NULL, thumbnail_default VARCHAR(255) DEFAULT NULL, thumbnail_medium VARCHAR(255) DEFAULT NULL, thumbnail_high VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_DFDBC36F6BBD148 (playlist_id), INDEX idx_identifier (identifier), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE slack_user (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, presence_id INT DEFAULT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(255) DEFAULT NULL, profile_id VARCHAR(64) NOT NULL, name VARCHAR(255) DEFAULT NULL, real_name VARCHAR(255) DEFAULT NULL, displayed_name VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, image_original_url VARCHAR(1024) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, is_admin TINYINT(1) DEFAULT NULL, is_app_user TINYINT(1) DEFAULT NULL, is_bot TINYINT(1) DEFAULT NULL, is_external TINYINT(1) DEFAULT NULL, is_forgotten TINYINT(1) DEFAULT NULL, is_invited_user TINYINT(1) DEFAULT NULL, is_owner TINYINT(1) DEFAULT NULL, is_primary_owner TINYINT(1) DEFAULT NULL, is_restricted TINYINT(1) DEFAULT NULL, is_stranger TINYINT(1) DEFAULT NULL, is_ultra_restricted TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_961B7CD6296CD8AE (team_id), UNIQUE INDEX UNIQ_961B7CD6F328FFC4 (presence_id), INDEX idx_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, slack_user_id INT DEFAULT NULL, google_user_id INT DEFAULT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(255) DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, login VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E6AA7332 (slack_user_id), UNIQUE INDEX UNIQ_8D93D649592AEE13 (google_user_id), INDEX idx_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, video_id INT NOT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', voted_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_5A108564A76ED395 (user_id), INDEX IDX_5A10856429C1004E (video_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE playlist ADD CONSTRAINT FK_D782112D25576DBD FOREIGN KEY (play_id) REFERENCES playlist_play (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649E6AA7332 FOREIGN KEY (slack_user_id) REFERENCES slack_user (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649592AEE13 FOREIGN KEY (google_user_id) REFERENCES google_user (id)');
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A108564A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A10856429C1004E FOREIGN KEY (video_id) REFERENCES playlist_video (id)');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649592AEE13');
        ...
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A10856429C1004E');
        $this->addSql('ALTER TABLE slack_action DROP FOREIGN KEY FK_87164B399AC0396');
        ...
        $this->addSql('ALTER TABLE slack_action DROP FOREIGN KEY FK_87164B39296CD8AE');
        ...
        $this->addSql('ALTER TABLE slack_action DROP FOREIGN KEY FK_87164B39A76ED395');
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649E6AA7332');
