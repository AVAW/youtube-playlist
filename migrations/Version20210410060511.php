 ...
 */
final class Version20210410060511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE playlist_video (id INT AUTO_INCREMENT NOT NULL, playlist_id INT NOT NULL, identifier BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', video_id VARCHAR(255) NOT NULL, title VARCHAR(512) NOT NULL, published_at DATETIME NOT NULL, INDEX IDX_DFDBC36F6BBD148 (playlist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
